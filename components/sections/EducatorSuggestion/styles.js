...
export const StyledContainer = styled.div`
  ...
  .content {
    ${tw`flex flex-col md:(flex-row) lg:(mt-24) w-full justify-center gap-8 items-center`}
...
export const Header = styled.div`
  ${tw`flex flex-col gap-2 mb-4 text-center lg:(mb-12 gap-4 px-12 mt-12 text-left)`}
